...
export declare const DROPDOWN_FOCUS_HANDLER_PROVIDER: ({
    provide: import("@angular/core/src/di/injection_token").InjectionToken<string>;
    useFactory: typeof import("../../../utils/id-generator/id-generator.service").uniqueIdFactory;
} | import("@angular/core/src/type").Type<DropdownFocusHandler> | {
    provide: typeof FocusableItem;
    useExisting: import("@angular/core/src/type").Type<DropdownFocusHandler>;
})[];
