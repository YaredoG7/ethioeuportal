...
.btn clr-icon {
  transform: translate3d(0rem, -0.08333333rem, 0); }
...
.btn-sm:not(.btn-link) clr-icon, .alert-app-level .alert-item .btn:not(.btn-link) clr-icon {
  width: 0.5rem;
  height: 0.5rem;
  transform: translate3d(0rem, -0.04166667rem, 0); }
...
.table.table-noborder {
  ...
  .table.table-noborder td {
    border-top: 0 none;
    padding-top: calc(0.45833333rem + 1px); }
...
.tooltip {
  ...
  .tooltip:focus > :first-child {
    outline-offset: 0.04166667rem;
    outline-width: 0.04166667rem;
...
.clr-checkbox-wrapper {
  ...
  .clr-checkbox-wrapper input[type='checkbox'] + label::after {
    ...
    content: '';
    display: none;
    height: 0.20833342rem;
    width: 0.3333335rem;
    border-left: 0.08333338rem solid #fff;
    border-bottom: 0.08333338rem solid #fff;
    top: 0.1666665rem;
    left: 0.16666675rem;
...
.clr-form-control-disabled .clr-checkbox-wrapper input[type='checkbox']:checked + label::after {
  border-left: 0.08333338rem solid #000;
  border-bottom: 0.08333338rem solid #000; }
...
.checkbox-inline {
  ...
  .checkbox-inline input[type='checkbox'] + label::after {
    ...
    height: 0.20833342rem;
    width: 0.3333335rem;
    border-left: 0.08333338rem solid white;
    border-bottom: 0.08333338rem solid white;
    top: 0.1666665rem;
    left: 0.16666675rem;
    transform: translate(0, 0.16666675rem) rotate(-45deg);
    border-color: #000; }
  ...
  .checkbox-inline.disabled input[type='checkbox']:checked + label::after {
    border-left: 0.08333338rem solid #22343c;
    border-bottom: 0.08333338rem solid #22343c; }
...
.stack-view {
  ...
  .stack-view .stack-block-label {
    ...
    .stack-view .stack-block-label::before {
      ...
      height: 0.416667rem;
      width: 0.416667rem;
      margin: 0.29166667rem 0.25rem 0 0;
      text-align: center; }
...
.datagrid-row {
  ...
  .datagrid-row .datagrid-action-overflow {
    ...
    .datagrid-row .datagrid-action-overflow::after {
      ...
      border-right: 0.20833333rem solid #22343c;
      border-top: 0.20833333rem solid transparent;
      border-bottom: 0.20833333rem solid transparent; }
    .datagrid-row .datagrid-action-overflow .action-item {
      ...
      cursor: pointer;
      display: block;
      line-height: calc(1rem - 0.04166667rem);
      margin: 0;
      padding: 1px 1rem 0;
      text-align: left;
      width: 100%; }
...
.clr-wizard .modal-dialog {
  ...
  -ms-flex-align: center;
  align-items: center;
  box-shadow: 0 0.04166667rem 0.08333333rem 0.08333333rem rgba(0, 0, 0, 0.2);
  height: 50%;
  max-height: 100%; }
