...
<p style="font-size: 14px; line-height: 16px; margin: 0;"><strong><span style="font-size: 28px;"> <span style="color: #339966; font-size: 28px;">Welcome, </span> to ET-EU portal</span></strong></p>
</div>
</div>
...
<p  style="font-size: 20px; line-height: 35px;">
	An account has been created for you to access the portal, use this email address <span style="color: #0281a8; font-size: 18px;">${message.to}</span> and access code
	to change your password. <br>
	You can find the portal here: <a href="https://vitelecomportal.online/authentication/reset_password" target="_blank" style="display: inline-block; color: ##18a4cf; cursor: pointer; text-decoration: underline; font-size: 18px; font-weight: bold; margin: 0; ">Ethio-EU Portal</a>
	</p>
	</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
