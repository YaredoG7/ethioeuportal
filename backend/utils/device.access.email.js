...
async function sendAccessCodeMail(message) {
...
<p style="font-size: 14px; line-height: 16px; margin: 0;"><strong><span style="font-size: 46px; line-height: 55px;">ViTelecom portal, <span style="color: #339966; font-size: 46px; line-height: 55px;">Access</span>!</span></strong></p>
</div>
</div>
...
<p style="font-size: 12px; line-height: 30px; margin: 0;"><span style="font-size: 20px;">You have used a new device to access ViTelecom Portal. Use the access code given below to link this device with your <span style="line-height: 30px; font-size: 20px;">account</span></span></p>
<p style="font-size: 12px; line-height: 30px; margin: 0;"><span style="font-size: 20px; color: #33cccc;"><span style="color: #008000; line-height: 30px; font-size: 20px;"><strong>ACCESS CODE: ${message.code}</strong></span></span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if (!mso)&(!IE)]><!-->
...
<p style="font-size: 14px; line-height: 21px; text-align: center; margin: 0;"><a href="https://hahucomputers.com/" rel="noopener" style="text-decoration: underline; color: #000;" target="_blank">Developers: hahu computer engineering</a></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if (!mso)&(!IE)]><!-->
...
module.exports = sendAccessCodeMail;
